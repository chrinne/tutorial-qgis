...
- 2021: https://ideib.caib.es/geoserveis/services/imatges/GOIB_Ortofoto_2021_IB/MapServer/WMSServer 
- 1956: https://ideib.caib.es/geoserveis/services/imatges/GOIB_Ortofoto_1956_IB/MapServer/WMSServer
...
Der Rasterrechner vor Version 3.22 kannte keine *if-than-else*-Syntax. Die Rückgabe der zu prüfenden Bedingung war "1" für WAHR und "0" für FALSCH. Mit einer geschickten Kombination von Multiplikation oder Division konnten entsprechende Wenn-Dann-Berechnungen gebaut werden. Im folgenden Fall z.B. die Division durch 0 = ungültig: 

```
(("closos_1_modifiziert@1">6) and ("closos_1_modifiziert@1"<17)) /
(("closos_1_modifiziert@1">6) and ("closos_1_modifiziert@1"<17))
```
Für die neue Version von QGIS gibt es es die [IF]-Bedingung mit folgender Syntax: if (Bedingung, wenn WAHR, wenn FALSCH)
