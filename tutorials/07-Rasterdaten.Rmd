...
| Anmerkung |
|----|
| Um aus zahlreichen Punkten diverser Felder jeweils ein zugehöriges Polygon zu erstellen könne Sie die Funktion *ST_ConvexHull()* nutzen. |
| Im vorliegenden Fall werden die unregelmäßigen Felder 2 und 3 nicht schön dargestellt. : ```select FeldNr, ST_ConvexHull(ST_Collect(geometry)) as geom from pp_magnetik_2010 group by 1``` |
