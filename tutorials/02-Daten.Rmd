...
Im Kapitel der Rasterverarbeitung werden wir Orthofotos als *wms* einbinden, einen Ausschnitt herunterladen und auswerten. Beim [ideIB](http://ideib.caib.es) finden Sie zahlreiche weitere WMS-Dienste, u.a. eine [Basiskarte für die Balearen](http://ideib.caib.es/cataleg/srv/spa/catalog.search#/metadata/AABE16F1-D7CC-40C3-8A74-D910CD8DE03F). Die dort genannte WMS-Adresse: "https://ideib.caib.es/geoserveis/services/public/GOIB_MapaBase_IB/MapServer/WMSServer" tragen  Sie in der Datenquellenverwaltung (\<strg> + \<l>)  -> WMS/WMTS, [Neu] unter URL ein und geben Sie dem neuen Eintrag einen sinnvollen Namen, z.B. SP-Balears Basiskarte.
...
Die Quelle ist das [Instituto Nacional de Estadística](https://www.ine.es) und listet die Einwohnerzahlen für die Baleareninseln nach Gemeinden und Zensus. Für die Übung wurden die originalen Daten der Felder "Población de Hecho" (faktisch) und "Población de Derecho" (rechtlich) gemittelt. Die Dateien unterscheiden sich minimal aber mit erheblichen Konsequenzen im Namen und den Spaltenbezeichnungen.
...
Auch in der Archäologie müssen wir bei Kartierungen von Befunden oder Funden den Gültigkeitraum abgrenzen und dies visuell deutlich machen, nur so ist die Darstellung korrekt. Dies ist in GIS z.B. durch einen weiteren Layer einer Polygonkarte möglich, in der die nicht erhobenen Flächen grau, die erhobenene Flächen aber Transparent dargestellt werden. Damit sind nur die Inhalte im erfassten Bereich sichtbar und der Arbeitsraum unverkennbar visualisiert.
